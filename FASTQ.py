...
#             sum_GC += ord(record['quality'][index])-33
#     q1.append(sum_GC)
...
def draw_hist(myList,Title,Xlabel,Ylabel,Xmin,Xmax,Ymin,Ymax):
    plt.hist(myList,bins=200,color=['slateblue'],edgecolor=[0.8,0.8,0.8,0.8],alpha=0.5)
    plt.xlabel(Xlabel)
    plt.xlim(Xmin,Xmax)
    plt.ylabel(Ylabel)
    plt.ylim(Ymin,Ymax)
